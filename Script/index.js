...
let system = () => {
    const items = [
        ...
        { name: "Zinger Combo", img: "./Img/SIGSWCBO.jpg", price: "P810" },
        { name: "2-PC Fully Loaded Meal", img: "./Img/2PCFLBOXCBO.jpg", price: "P275" },
        { name: "Ala King Zinger Steak Meal With Buttered Corn", img: "./Img/AKZSMBCORNCBO.jpg", price: "P180" },
        { name: "Creamy Iced Coffee", img: "./Img/CREAMICEDCOFFEE.jpg", price: "P65" },
        { name: "Large Shots Combo", img: "./Img/SHOTS-LCBO.jpg", price: "P190" },
        { name: "Zinger Sandwich Fully Loaded Meal", img: "./Img/ZNGRSNDWCHFLM.jpg", price: "P280" },
        { name: "Smoky BBQ Zinger Ala Carte", img: "./Img/SBBQZINGER.jpg", price: "P165" },
        { name: "Smokey BBQ Zinger Combo", img: "./Img/SBBQZINGERCBO.jpg", price: "P210" },
        { name: "Coffee float", img: "./Img/CFFEEFLOAT.jpg", price: "P75" },
        { name: "Zinger stacker", img: "./Img/ZSTACKER.jpg", price: "P240" },
        { name: "Zinger stacker combo", img: "./Img/ZSTACKERCBO.jpg", price: "P300" },
        { name: "Holiday Brownie Box", img: "./Img/HOLBRWNYBOX.jpg", price: "P205" },
        { name: "Bucket of 8pcs chicken + side", img: "./Img/HEHE.jpg", price: "P970" },
        { name: "Bucket of chicken & Steak + Side", img: "./Img/hihi.jpg", price: "P970" },
        { name: "Bucket of shots + side", img: "./Img/hoho.jpg", price: "P970" },
        { name: "Bucket of nuggets + side", img: "./Img/hahahaha.jpg", price: "P970" },
    ];
